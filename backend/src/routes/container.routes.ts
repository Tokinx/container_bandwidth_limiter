...
router.get('/', authMiddleware, async (req: Request, res: Response) => {
  try {
    const containers = containerRepo.findAll();
    res.json(containers);
  } catch (error) {
...
router.put('/:id', authMiddleware, async (req: Request, res: Response) => {
  try {
    ...
    const updated = containerRepo.update(req.params.id, {
      bandwidth_limit,
      bandwidth_extra,
      reset_day,
      expire_at,
...
router.post('/:id/start', authMiddleware, async (req: Request, res: Response) => {
  try {
    ...
    containerRepo.updateStatus(req.params.id, 'active');
...
router.post('/:id/stop', authMiddleware, async (req: Request, res: Response) => {
  try {
    ...
    containerRepo.updateStatus(req.params.id, 'stopped');
