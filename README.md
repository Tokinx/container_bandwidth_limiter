...
点击容器卡片右上角的 **「配置」** 按钮，可以设置：

- **流量限制 (GB)**：每月基础流量配额，留空表示无限制
- **临时额外流量 (GB)**：临时增加的流量配额，重置时会清零
- **每月重置日期 (1-31)**：每月的哪一天重置流量统计
- **到期时间**：容器到期后将自动停止，留空表示永不过期
...
临时额外流量：50 GB
重置日期：1（每月1号）
到期时间：2025-12-31 23:59
```
表示：本月总共 150GB 流量，下月重置后恢复为 100GB，2025年底自动停止。
